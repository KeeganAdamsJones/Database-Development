...
# Author: Keegan Jones
# Date: 2/15/2021
# Description: PySports Update and Deletes

# Code to Connect to PySports Database
# Import Statements
...
def show_players(cursor, title):
    ...
    # Iterate through the player data, display the results 
...
try:
    ...
    # Display all players in the player table
    show_players(cursor, "DISPLAYING PLAYERS AFTER INSERT")

    # update the newly inserted record 
    update_player = ("UPDATE player SET team_id = 2, first_name = 'Mary', last_name = 'Poppins' WHERE first_name = 'Baby'")
    ...
    # delete query 
    delete_player = ("DELETE FROM player WHERE first_name = 'Mary'")
