...
def display_mainMenu():
    ...
    # set up for selection input and handle errors
    try: 
...
# if user chooses view store locations
...
# if user chooses my account
# validate user id to login and handle errors
def validate_user():
    user_id = 0
    try:
...
# display the users account menu and handle errors
